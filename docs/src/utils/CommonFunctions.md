...
The `CommonFunctions` class provides a collection of utility functions for various common operations, including
directory management, string manipulation, date formatting, and Excel file handling.
...
### Visual Representation of Core Functionalities

Below is a diagram that illustrates the various core functionalities of the `CommonFunctions` class:

```plaintext
+--------------------------+              +----------------------------+
|  String Manipulation     |              |  Date Formatting           |
| - Replace all occurrences|              | - Convert Epoch to Date    |
| - Wrap with Ellipsis     |              | - Format Dates             |
+--------------------------+              +----------------------------+
              |                                      |
              v                                      v
+--------------------------+              +----------------------------+
|  Excel File Handling     |              |  Number Manipulation       |
| - Read Excel Files       |              | - Round Numbers            |
| - Transform Gherkin Table|              | - Min-Max Value Calculation|
+--------------------------+              +----------------------------+
```

This diagram highlights the main categories of utility functions available in the `CommonFunctions` class, making it
easier to understand the broad range of operations.
...
operations in JavaScript applications, particularly those involving Playwright for testing. These methods are designed
to streamline processes such as directory management, data formatting, and Excel file handling.